...
A side effect is anything that affects something outside of the scope of a function. An example of syncing side effects
is (!state) > something happens, like giving the application time to grab the axios call so it loads on the page.
